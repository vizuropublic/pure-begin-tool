	...
	theme: {
		...
		extend: {
			colors: {
				...
				listed: {
					DEFAULT: 'hsl(var(--listed))',
					foreground: 'hsl(var(--listed-foreground))'
				},
				ordered: {
			...
			fontSize: {
				...
				'heading-tertiary': 'var(--heading-tertiary)',
      },
      spacing: {
        'page': 'var(--page-padding)',
        'page-header': 'var(--page-header-margin)',
        'content': 'var(--page-header-margin)',
			},
			maxWidth: {
